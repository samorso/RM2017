...
4. Same as 3 but with a one population test. What am I assuming when making this test?   
5. Repeat 3 and 4 with the Wilcoxon's signed-rank test. Is the conclusion different? How can you check if there are outliers?   
</div>
