...
* Evaluation: two group projects (~4 students randomly assigned) (20%) and a final exam (80%)  
* Class material on https://cyberlearn.hes-so.ch/   
* The most current version of the course is available on https://samorso.github.io/RM2017/RM.html   
...
1. In-class exercises: you will have time during the class to solve these exercises, then I correct it with you.  
2. Homeworks: you have to solve these exercices by your own at home. You receive a detailed solution. In principle I will not give further correction.  
...
```
The correlation is `r round(cor(mtcars$mpg,mtcars$wt),4)`.
